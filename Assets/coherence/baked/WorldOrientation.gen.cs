...
namespace Coherence.Generated
{
	...
	public struct WorldOrientation : ICoherenceComponentData
	{
		...
		public static (WorldOrientation, uint, uint?) DeserializeArchetypeBichocubo_290ed8bd23cfc8448a1301f7831c2768_WorldOrientation_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new WorldOrientation();
			if (bitStream.ReadMask())
